...
const builder = {
    ...
    insertion_failed: (prefix) => builder.prepare(403, prefix, 'insertion failed'),
    updation_failed: (prefix) => builder.prepare(403, prefix, 'updation failed'),
    ...
    already_deleted: (prefix) => builder.prepare(403, prefix, 'already deleted'),
